...
2. **대시보드:**
    ...
    7. 정답률 = (전체 정답 수 ÷ 전체 퀴즈 수) x 100
    8. 완료율 = (퀴즈팩 완료 사용자수 ÷ Active User) x 100
    9. 가장 빠른 사용자:
        - 정의: quizpack_loadmap 기준 완료한 퀴즈팩의 pack_order가 가장 큰 사용자
        - 표시 정보: 사용자 id, 닉네임, 완료한 퀴즈팩의 pack_order
    10. 별점: 별점이 기록된 모든 퀴즈팩의 별점 평균 average(quizpack_statistics.average_rating)
3. **콘텐츠 관리:**
...
5. **활동 관리:**
    ...
    3. 사용자 목록 표시 정보:
        ...
        12. 퀴즈팩 완료율 → (사용자가 완료한 퀴즈팩 개수 ÷ 전체 퀴즈팩 개수) × 100
